  ...
  -H <span class="tok-s">"x-kirra-client-id: dev"</span></code></pre>
        ...
        <div class="stats stats--4" data-reveal style="margin-top:24px">
          <div class="stat">
            ...
            <p class="stat__evidence">${ev("src/wcet_gate.rs:119#pub const GOVERNOR_VERDICT_WCET_TARGET_MICROS", "wcet_gate.rs")}</p>
          </div>
          <div class="stat">
        ...
        <div class="grid grid--2" style="align-items:start">
          ...
          <div style="display:grid;gap:14px">
            ...
            <div class="card" data-reveal>
              ...
              ${evRow("examples/", ".github/workflows/ci.yml:427#docs-and-sdk:")}
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="grid grid--3">
          ...
          <div class="card" data-reveal>
            ...
            ${evRow(".github/workflows/ci.yml:427#docs-and-sdk:", "examples/")}
          </div>
          <div class="card" data-reveal>
