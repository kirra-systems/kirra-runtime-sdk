      ...
      <div class="container">
        ...
        <div class="grid grid--3" style="margin-top:40px">
          ...
          <div class="card" data-reveal>
            ...
            ${evRow("verification/kani/", ".github/workflows/ci.yml:277#- name: frozen-talisman blob pin survives formatting")}
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="stats stats--4" data-reveal>
          <div class="stat">
            ...
            <p class="stat__evidence">${ev(".github/workflows/ci.yml:312#name: Test", "ci.yml · Test")}</p>
          </div>
          <div class="stat">
        ...
        <div class="grid grid--3" style="margin-top:20px">
          <div class="card" data-reveal>
            ...
            ${evRow("fuzz/fuzz_targets/", ".github/workflows/ci.yml:793#mutation-gate:")}
          </div>
          <div class="card" data-reveal>
            ...
            ${evRow(".github/workflows/ci.yml:484#checker-coverage:", "codecov.yml")}
          </div>
          <div class="card" data-reveal>
