  ...
  lede: "Kirra's architecture is one long argument for isolation: untrusted doers in their own partition, a minimal verdict core at the boundary, and a control plane that assumes every carrier is hostile. Here is how the pieces fit — with the decision records that shaped them.",
    ...
    <section aria-labelledby="h-topo">
      <div class="container">
        ...
        ${evRow("docs/adr/0032-governor-deployment-platform.md", "docs/safety/HYPERVISOR_CONTRACT_CHANNEL.md", "crates/kirra-contract-channel/src/lib.rs", ".github/workflows/ci.yml:209#qnx-governor-artifact:")}
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="grid grid--3" style="margin-top:32px">
          ...
          <div class="card" data-reveal>
            ...
            ${evRow("crates/kirra-persistence", "crates/kirra-persistence/src/postgres", ".github/workflows/ci.yml:657#postgres-conformance:")}
          </div>
        </div>
      </div>
    </section>
