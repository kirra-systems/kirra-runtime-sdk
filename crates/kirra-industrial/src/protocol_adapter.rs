...
use kirra_policy_types::action_claim::{evaluate_action_claim, ActionClaim, ActionDecision};
...
pub struct UnifiedEvaluationResult {
    pub protocol: String,
    pub command: kirra_policy_types::OperationalCommand,
    pub allowed: bool,
...
pub fn command_allowed_for_posture_pub(
    command: &kirra_policy_types::OperationalCommand,
    posture: &FleetPosture,
) -> (bool, Option<String>) {
    use kirra_policy_types::OperationalCommand;
    match command {
...
mod unified_tests {
    ...
    fn legacy_modbus_write_missing_value_fails_closed_b7() {
        ...
        assert_eq!(r.command, kirra_policy_types::OperationalCommand::Unknown);
        assert_eq!(
