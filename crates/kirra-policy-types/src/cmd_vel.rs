// crates/kirra-policy-types/src/cmd_vel.rs
//
// ADR-0035 Stage 0b: moved VERBATIM from the root crate's `src/gateway/cmd_vel.rs`
// (pure move — behaviour-identical). `kirra-verifier::gateway::cmd_vel` re-exports
// these. serde-only; a lean leaf.
