  ...
  return (
    <ResponsiveContainer width="100%" height={height}>
      <LineChart data={data} margin={{ top: 6, right: 8, left: -16, bottom: 0 }}>
        ...
        <XAxis dataKey="t" tick={{ fill: 'var(--c-faint)', fontSize: 10, fontFamily: 'monospace' }} axisLine={false} tickLine={false} minTickGap={32} />
        <YAxis domain={[0, 100]} tick={{ fill: 'var(--c-faint)', fontSize: 10, fontFamily: 'monospace' }} axisLine={false} tickLine={false} width={42} unit="%" />
