...
- Phase 3 (Stage 3–4): systematic ISO 21448 trigger catalog (weather, blooming, spray, low-sun, degraded markings, VRU edge cases, adversarial patches) with per-trigger scenario coverage and residual-risk ledger; adversarial-prompt eval suite for the Mick LLM seam.
