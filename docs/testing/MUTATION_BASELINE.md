...
## 3. Genuine survivor debt (198 mutants after the §4 starter kills)

| File | Survivors | Dominant clusters |
|---|---:|---|
| `validation.rs` | 99 | `predictive_rss_breach` (45), `validate_trajectory_slow_capped` (28), occlusion/steering helpers |
