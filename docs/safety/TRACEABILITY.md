...
|---|---|---|
| **ENFORCED** | At least one Governor code site is tagged and tested | SG1, SG3, SG7, SG8 (Governor side), SG9 |
...
| **PENDING** | Coverage hole: a real implementation gap, tracked in its own issue | SG2 |
...
The CI gate at `traceability_gate::traceability_gate_ci` recognizes these as
explicit non-violations:

| SG | Status | Tracked by |
|---|---|---|
| SG2 | PENDING | new issue filed in the S3 traceability-build commit |
