...
Wave 3 remaining: WP-18 whole-store `VerifierStorage` trait + live-PG binding (migration-engine trait + PG migration backend DONE) · WP-19 slice 2 (live-loop wiring) · WP-20 slice 2 (main() adoption + syscalls) · WP-24 slice 2 (signed-manifest + live backend/tick wiring).
