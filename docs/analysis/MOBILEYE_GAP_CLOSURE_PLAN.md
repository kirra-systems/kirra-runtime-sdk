...
Wave 3 remaining: WP-18 slices 2/3 (trait + PG) · WP-19 slice 2 (live-loop wiring) · WP-20 slice 2 (main() adoption + syscalls) · WP-24 slice 2 (signed-manifest + live backend/tick wiring).
