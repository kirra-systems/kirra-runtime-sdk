...
Wave 3 remaining: WP-18 remaining store domains + live-PG binding (migration trait + PG migration backend + EpochFence storage trait DONE) · WP-19 slice 2 (live-loop wiring) · WP-20 slice 2 (main() adoption + syscalls) · WP-24 slice 2 (signed-manifest + live backend/tick wiring).
